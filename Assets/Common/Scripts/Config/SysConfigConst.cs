...
namespace BattleFramework.Data{
    ...
    public class SysConfigConst {
		...
		public const string startFighterPlaneFlyDuring="startFighterPlaneFlyDuring";
		...
		public const string antiInterval = "antiInterval";
		public const string hunZhanTime = "hunZhanTime";//混战时间-从战斗开始
		public const string leiJiTime = "leiJiTime";//雷击时间-从战斗开始
		public const string yeZhanTime = "yeZhanTime";//夜战时间-从战斗开始
		public const string shipMoveIntervalTime = "shipMoveIntervalTime";
    }
}