...
//        Dictionary<UnityEngine.Transform, FixedPointMoveAgent> mMoveableCharacterDic;

//        void Awake()
//        {

//            //PathFindingMananger.NewInstance();

//            //mPathFindingMananger = PathFindingMananger.Single;
...
//                    mPathAgent.StartFind(target.position.ToFixedPointVector3(), raycastHit.point.ToFixedPointVector3());

//                    //StartCoroutine(mPathAgent._StartFind(target.position.ToFixedPointVector3(), raycastHit.point.ToFixedPointVector3(),null));    
//                }
...
//            }
//            mMoveAgent.SetPath(searchComplete, null);
//        }
...
//            mMoveAgent.onPositionChange = (FixedPointTransform fixedPointTransform) =>
//            {
//                modelGO.transform.position = fixedPointTransform.position.ToVector3();
//            };

//            mMoveAgent.onNodeChange = (FixedPointTransform fixedPointTransform) =>
//            {
//                modelGO.transform.position = fixedPointTransform.position.ToVector3();
//                modelGO.transform.forward = fixedPointTransform.forward.ToVector3();
//            };
